...
def dense_block(x, blocks, name, params=PARAM_NONE):
    ...
    for i in range(blocks):
        x = conv_block(x, 32, params=params, name=name + '_block' + str(i + 1))
    return x
...
def DenseNet(blocks,
    ...
    x = layers.Conv2D(64, 7, strides=2, use_bias=False, name='conv1/conv')(x, params=params)
    x = layers.BatchNormalization(
        axis=bn_axis, epsilon=1.001e-5, name='conv1/bn')(x, params=params)
    ...
    x = layers.BatchNormalization(
        axis=bn_axis, epsilon=1.001e-5, name='bn')(x, params=params)
